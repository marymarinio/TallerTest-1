...
digitosnocorrespondiente=[".","#","@"]
placa=input("Ingrese el informe de la placa: ")
valor=0
c=0
for contador in placa:
    if len(placa)<=8:
        if contador in digitosnocorrespondiente:
    ...
    c=c+1
if valor == 0:
    print("la placa ",placa," es valida")
else:
    print("la placa ",placa," no es valida")